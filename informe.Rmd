...
datos_uso_tiempo %>% 
  ...
  gt(caption = "Personas según tipo de día") %>% 
...
datos_uso_tiempo %>%
  ...
  scale_color_discrete(name = "Sexo") +
  labs(title = "Correlación entre horas dedicadas al trabajo pago y a trabajo
       doméstico no pago y tareas de cuidados", 
       x = "Trabajo pago", 
...
datos_uso_tiempo %>%
  ...
  labs(title = "Horas dedicadas al trabajo pago según nivel educativo según sexo", 
       x = "Nivel educativo", 
       y = "Cantidad de horas")  
...
datos_uso_tiempo %>%
  ...
  labs(title = "Horas dedicadasal trabajo doméstico no pago
